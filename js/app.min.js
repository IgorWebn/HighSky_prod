    ...
    if(
        ...
        if(value>=0 && value<=20){
           // output.style = "clip-path: polygon( 0% 52%," + dX + "% " + dY + "%, 50% 52%);";
            polygon.setAttribute('points',`0,${outputWidth*52} ${outputWidth*dX},${outputWidth*dY} ${outputWidth*50},${outputWidth*52}`)
           // console.log('poly',polygon.getAttributeNode('points'));
        }
    }else if(
        0 <= dX && dX < 50 && dY == 0
    ){
        ...
        if(value>=0 && value<=20){
          //  output.style = "clip-path: polygon( 0% 52%,0% 0%," + dX + "% " + dY + "%, 50% 52%);";
            polygon.setAttribute('points',`0,${outputWidth*52} 0,0 ${outputWidth*dX},${outputWidth*dY} ${outputWidth*50},${outputWidth*52}`)
        }
    }else if(
        50 <= dX && dX <= 100 && dY == 0
    ){
        ...
        if(value>=0 && value<=20){
           // output.style = "clip-path: polygon( 0% 52%,0% 0%,50% 0%," + dX + "% " + dY + "%, 50% 52%);";
            polygon.setAttribute('points',`0,${outputWidth*52} 0,0 ${outputWidth*50},0 ${outputWidth*dX},${outputWidth*dY} ${outputWidth*50},${outputWidth*52}`)
        }
    }else if(
        dX == 100 && 0 <= dY && dY <= 50
    ){
        ...
        if(value>=0 && value<=20){
          //  output.style = "clip-path: polygon( 0% 52%,0% 0%,50% 0%,100% 0%," + dX + "% " + dY + "%, 50% 52%);";
            polygon.setAttribute('points',`0,${outputWidth*52} 0,0 ${outputWidth*50},0 ${outputWidth*100},0 ${outputWidth*dX},${outputWidth*dY} ${outputWidth*50},${outputWidth*52}`)
        }
    }
